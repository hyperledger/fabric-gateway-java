...
target_repo=$GATEWAY_JAVA_USERNAME.github.io.git
...
cp -r $WORKSPACE/$BASE_DIR/target/apidocs/* $GATEWAY_JAVA_USERNAME.github.io
...
git config remote.gh-pages.url https://$GATEWAY_JAVA_USERNAME:$GATEWAY_JAVA_PASSWORD@github.com/$GATEWAY_JAVA_USERNAME/$target_repo
